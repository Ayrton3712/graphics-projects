...
//		-0.5f,  0.5f, 0.0f, // Third vertex (top, perpendicular to first vertex)
//		 0.5f,  0.5f, 0.0f  // Fourth vertex (top, perpendicular to second vertex)
//	};
//
...
//		glDrawArrays(GL_TRIANGLES, 0, 4);	// Drawing the triangle. This tells OpenGL to draw triangles using the currently bound VAO, starting from the first vertex (0) and drawing 3 vertices (which form one triangle).
